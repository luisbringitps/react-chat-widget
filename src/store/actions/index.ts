...
export function addUserMessage(text: string, footer?: string, id?: string): actionsTypes.AddUserMessage {
  return {
...
export function addResponseMessage(text: string, footer?: string, id?: string): actionsTypes.AddResponseMessage {
  return {
