...
export function addUserMessage(text: string, fotter: string): void;
export function addUserMessage(text: string, fotter: string, id: string): void;

export function addResponseMessage(text: string): void;
export function addResponseMessage(text: string, fotter: string): void;
export function addResponseMessage(text: string, fotter: string, id: string): void;
